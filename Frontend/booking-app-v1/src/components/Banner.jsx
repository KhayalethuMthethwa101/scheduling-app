    ...
    <div className='flex bg-primary rounded-lg px-6 sm:px-10 md:px-14 lg:px-12 my-20 md:mx-10'>
        ...
        <div className='flex-1 py-8 sm:py-10 md:py-16 lg:pl-5'> 
            <div className='text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold text-white'>
                <p>RSVP to you favorite Events</p>
                <p className='mt-4'>With 5+ Categories</p>
            </div>
        ...
        {/*-----------Right side---------- */}
        <div className='hidden md:block md:w-12 lg:w-[370px] relative'>
            <img className='w-full absolute bottom-0 right-0 max-w-md' src={assets.banner_image} alt="" />
        </div>
    </div>
  )
}
