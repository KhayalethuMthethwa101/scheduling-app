...
const Login = () => {
  ...
  const onSumbitHandler = async (instance)=>{
    instance.preventDefault()
  }

  return (
    <form className='min-h0[80vh] flex items-center'>
        <div className='flex flex-col gap-3 m-auto items-start p-8 min-w-[340px] sm:min-w-96 border rounded-xl text-zinc-600 text-sm shadow-lg'>
          ...
          <div className='w-full'>
            <p>Password</p>
            <input className='border vorder-zinc-300 rounded w-full p-2 mt-1' type='password' onChange={(e)=>setPassword(e.target.name)} value={password} required/>
          </div>
